...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_dir", type = str, default = 'weights/mnist_cifar10_imbalanced/' )
    ...
    minority_class_labels = [0, 1, 2, 3, 4, 5, 6 ]
    ...
    trainset = mnist.MNIST(root = 'data/MNIST', train = True,
                         download=True,
    ...
    testset = mnist.MNIST(root = 'data/MNIST', train = False,
                         download=True,
                         transform=transforms.Compose([
                            transforms.ToTensor(),
                            transforms.Normalize((0.5,), (0.5,))]),
    ...
    backbone.conv1 = torch.nn.Conv2d(1, 64,
            kernel_size=(7, 7),
            stride=(2, 2),
